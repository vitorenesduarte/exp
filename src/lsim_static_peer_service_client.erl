...
-module(lsim_static_peer_service_client).
...
%% lsim_static_peer_service_client callbacks
-export([start_link/1]).
...
%% gen_server callbacks
init([Socket]) ->
    ldb_log:info("lsim_static_peer_service_client initialized! Node ~p listening to socket ~p", [node(), Socket], extended),
